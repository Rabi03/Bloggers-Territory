...
const {dashboard,profile,createBlog,getBlog,upvote,downvote,openCreateBlogPage,uploadImage,comment,getTimeLine,notifyChange,reportToAdmin,userProfile,getUserTimeLine,editBlog,getEditBlog} = require('../controllers/home');
...
router.route('/profile/:id').get(isUserAuthenticated,isAccountDeleted,userProfile);
